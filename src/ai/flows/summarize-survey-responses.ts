...
const prompt = ai.definePrompt({
  ...
  The summary must be a single, well-written paragraph. It should be no more than 3 sentences long. Do not use more than one paragraph. Do not use line breaks.
